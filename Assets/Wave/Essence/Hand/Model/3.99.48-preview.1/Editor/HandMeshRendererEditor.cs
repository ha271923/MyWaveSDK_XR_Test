...
MessageType.Warning);
			...
			MessageType.None);
			handMeshRenderer.ShowElectronicHandIfSupported = EditorGUILayout.Toggle("Show electronic hand if supportted", handMeshRenderer.ShowElectronicHandIfSupported);
