	...
	public class InteractionModeButton : MonoBehaviour
	{
		...
		public void GazeMode()
		{
			if (InteractionModeManager.Instance != null)
			{
				...
				ClientInterface.InteractionMode = XR_InteractionMode.Gaze;
			}
		}
		public void ControllerMode()
		{
			if (InteractionModeManager.Instance != null)
			{
				DEBUG("Set interaction mode to Controller.");
				ClientInterface.InteractionMode = XR_InteractionMode.Controller;
			}
		}
		public void HandMode()
		{
			if (InteractionModeManager.Instance != null)
			{
				...
				ClientInterface.InteractionMode = XR_InteractionMode.Hand;
			}
		}
	}
}
