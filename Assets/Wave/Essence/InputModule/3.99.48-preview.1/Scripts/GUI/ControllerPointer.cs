	...
	sealed class ControllerPointer : MonoBehaviour
	{
		...
		private void Start()
		{
			if (EventSystem.current == null)
			{
				...
				{
					m_ControllerInputModule = event_system.gameObject.GetComponent<ControllerInputModule>();
				}
			}
			else
			{
			...
			Log.i(LOG_TAG, "Start() ControllerInputModule " + (m_ControllerInputModule != null ? "existed." : "does NOT exist."), true);
		}
