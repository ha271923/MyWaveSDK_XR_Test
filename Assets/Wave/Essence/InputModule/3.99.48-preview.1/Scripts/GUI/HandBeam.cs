	...
	public sealed class HandBeam : MonoBehaviour
	{
		...
		private void Start()
		{
			if (EventSystem.current == null)
			{
				...
				{
					m_HandInputModule = event_system.gameObject.GetComponent<HandInputModule>();
				}
			}
			else
			{
			...
			Log.i(LOG_TAG, "Start() HandInputModule " + (m_HandInputModule != null ? "existed." : "does NOT exist."), true);
		}
