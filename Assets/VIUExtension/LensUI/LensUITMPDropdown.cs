...
public class LensUITMPDropdown : LensUISelectable, IPointerClickHandler, ISubmitHandler, ICancelHandler
{
    ...
    {
        [SerializeField]
        private LocalizedString m_I2Term;
        [SerializeField]
        ...
        /// <summary>
        /// The I2 term associated with the option.
        /// </summary>
        public LocalizedString I2Term { get { return m_I2Term; } set { m_I2Term = value; } }
        ...
        public OptionData(LocalizedString term)
        {
            this.I2Term = term;
        }
        ...
        /// <param name="term">Optional term for the option.</param>
        public OptionData(LocalizedString term, string text)
        {
            this.I2Term = term;
            this.text = text;
        }
    ...
    [Serializable]
    /// <summary>
    /// Function definition for a dropdown click event.
    /// </summary>
    public class DropdownClickedEvent : UnityEvent { }

    [SerializeField]
    private DropdownClickedEvent m_OnClick = new DropdownClickedEvent();

    public DropdownClickedEvent onClicked { get { return m_OnClick; } set { m_OnClick = value; } }
    ...
    public void RefreshShownValue()
    {
        ...
        var temp = data.I2Term;

        if (m_CaptionText)
        {
            if (data != null && data.I2Term != null)
                m_CaptionText.text = data.I2Term.ToString();
    ...
    private void SetupTemplate()
    {
        ...
        GetOrAddComponent<CanvasRaycastTarget>(templateGo); //for vive pointers
    ...
    public void Show()
    {
        ...
        //Fix sorting issue
        var parent = GetComponentInParent<PageController>().transform;
        GetOrAddComponent<LayoutElement>(m_Blocker).ignoreLayout = true;
        m_Blocker.transform.SetParent(parent, true);
        GetOrAddComponent<LayoutElement>(dropdownRectTransform.gameObject).ignoreLayout = true;
        dropdownRectTransform.SetParent(parent, true);
    }
    ...
    protected virtual GameObject CreateBlocker(Canvas rootCanvas)
    {
        ...
        //Add this for VIU pointer
        blocker.AddComponent<CanvasRaycastTarget>();
    ...
    private DropdownItem AddItem(OptionData data, bool selected, DropdownItem itemTemplate, List<DropdownItem> items)
    {
        ...
        item.gameObject.name = "Item " + items.Count + (data.I2Term != null ? ": " + data.I2Term.mTerm : (data.text != null ? ": " + data.text : ""));
        ...
        {
            if (data.I2Term != null)
                item.text.text = data.I2Term.ToString();
            else
