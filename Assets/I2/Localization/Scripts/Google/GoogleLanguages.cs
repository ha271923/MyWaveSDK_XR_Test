...
namespace I2.Loc
{
    ...
    public static class GoogleLanguages
    {
        ...
        public static Dictionary<string, LanguageCodeDef> mLanguageDef = new Dictionary<string, LanguageCodeDef>(StringComparer.Ordinal)  
		{
            ...
            {"Japanese-JP",         new LanguageCodeDef(){PluralRule=0, Code="ja-JP", HasJoinedWords=true, GoogleCode="ja"}},
            ...
            {"Korean-KR",           new LanguageCodeDef(){PluralRule=0, Code="ko-KR", GoogleCode="ko"}},
            ...
            {"Russian-RU",             new LanguageCodeDef(){PluralRule=6, Code="ru-RU", GoogleCode="ru"}},
