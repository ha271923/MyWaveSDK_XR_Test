...
namespace I2.Loc
{
	public partial class LanguageSourceData
	{
		...
		void AppendTerm(StringBuilder Builder, int nLanguages, string Term, TermData termData, string specialization, char Separator)
		{
			//--[ Key ] --------------				
            ...
            for (int i=0; i<Mathf.Min (nLanguages, termData.Languages.Length); ++i)
			{
                ...
                var comment = isEnUs ? null : fallbackTranslation;
                AddDataInRoot(mDict[mLangList[i]], Term, translation, comment);
            }
			Builder.Append ("\n");
		}
