...
public class detectInputText : MonoBehaviour
{
	...
	private IMEManager pmInstance = null;
	...
	{
		pmInstance = IMEManager.instance;
	...
	private void showKeyboard(IMEManager.IMEParameter parameter)
	{
		if (!showKeyboard_ && initialized)
		{
	...
	public void showKeyboardEng()
	{
		...
		if (!initialized)
			InitializeKeyboards();
		IMEManager.IMEParameter parameter = mParameter;
		parameter.id = 0;
